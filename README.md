...
```yaml
analista:
  nome: "Letícia Torquato"
  cargo: "Analista Pleno de Qualidade (QA) & Processos"
  foco: ["QA Técnico de Software", "Engenharia de Processos", "SGQ"]
  setores: ["Healthtech", "Saúde Suplementar"]
  empresas: ["NEXDOM", "Unimed Curitiba", "Benner"]
  formacao:
  ...
  diferencial: >
    Ponte entre tecnologia, regulação e negócio — unindo testes de software,
    BDD e automação à governança de qualidade (Lean Seis Sigma, ISO 9001/14001,
    PDCA, 5S) e conformidade regulatória (TISS, TUSS, ANS, NIP).
```

> 💡 Atuo garantindo que o software funcione **e** que o processo por trás dele seja auditável, escalável e centrado na experiência do cliente (CX).
...
**Saúde Digital**
Desenvolvimento e validação ágil de MVPs sob alta pressão, com foco em qualidade de software, cenários de teste e UX.
...
**Saúde Digital**
Mapeamento e validação de regras de negócio em cenários operacionais complexos do setor de saúde.
...
### ⚡ NEXDOM Healthtech
Garantia da qualidade e evolução contínua de soluções em saúde digital.

</td>
<td width="50%" valign="top">

### 🏥 7+ anos — Unimed Curitiba
Padronização de processos, auditorias internas e gestão de não conformidades.
...
| 🧪 QA & Testes | ⚙️ Governança & SGQ | 📜 Regulatório | 🔄 Ágil & Modelagem |
|:---:|:---:|:---:|:---:|
| Testes Funcionais | Lean Seis Sigma (GB) | Normativas ANS | Scrum |
| Exploratórios | ISO 9001 / 14001 | TISS | Kanban |
| Regressão & Fumaça | PDCA / 5S | TUSS | Lean |
| Usabilidade | BPMN | Fluxos NIP | BDD (Gherkin) |
| Homologação | Análise de Riscos | — | — |
| Análise de Requisitos | Auditorias & KPIs | — | — |
...
| 🗂️ **[Gestão e Manutenção de Acervo Documental](./docs/README.md)** | Estruturação e governança documental corporativa com base em 5S |
...
> ⚠️ *Substitua `leticiatorquato` pelo seu **usuário real do GitHub** em todos os links de badges/stats acima para que eles funcionem corretamente.*
